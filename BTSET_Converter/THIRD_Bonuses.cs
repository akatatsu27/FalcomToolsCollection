...
internal class THIRD_Bonuses : Bonuses
{
	...
	[JsonProperty(Required = Required.Always, Order = 1)] public readonly byte Unk10;
	[JsonProperty(Required = Required.Always, Order = 2)] public readonly byte Unk11;

	internal THIRD_Bonuses(ref UInt16 offset, BTSET file)
	{
		Offset = offset;
