...
bool asitem::parse_from_binary(binary_context *const ctx, string *text)
{
    ...
    for (int i = 0; i < ASITEM_TOTAL_FUNCTIONS; i++) // total number of functions not specified anywhere
    {
